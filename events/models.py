...
class Event(models.Model):
  ...
  about = models.TextField('Страница О проекте', max_length=15000, null=True, blank=True)
  prog = models.TextField('Страница Программа', max_length=15000, null=True, blank=True)
