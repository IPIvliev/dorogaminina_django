...
class Event(models.Model):
  ...
  about = models.CharField('Страница О проекте', max_length=5000, null=True, blank=True)
  prog = models.CharField('Страница Программа', max_length=5000, null=True, blank=True)
